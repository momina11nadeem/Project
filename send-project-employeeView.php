...
<section class="w3-container" style="background-color:white; padding-bottom:3em; margin-top:5em;">
 ...
 <h2 class="text-center">Send Your Project</h2>
 <br><br><br>
...
<input type="file" >
<button class="btn btn-block M-button-orange-to-white btn-sm" style="margin-top:2em;"><a style="font-family: Arial; font-size: large;" class="M-Universal-Link">Send Project</a></button>
</form>
