...
<textarea class="w3-input" rows="10" style="overflow:scroll !important; border:1px solid green; " required></textarea>
 <label> Select ReSubmission Date</label>
 <div class="col-md-12">
 <input type="date" style="border: 1px solid green;">
  </div>
<label style="margin-top:1em;">Attatchment</label>
<input type="file" >
<button class="btn btn-block M-button-orange-to-white btn-sm" style="margin-top:2em;"><a style="font-family: Arial; font-size: large;" class="M-Universal-Link">Submit</a></button>
</form>
