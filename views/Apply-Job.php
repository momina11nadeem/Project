                ...
                <div style=" padding-top:3em; alignment-adjust:middle !important;">
                    <ul class="M-No-Style-List w3-container">
                        <li class=" col-md-8 col-md-offset-2">
                            <form class="w3-form w3-container col-md-12 " style="border:2px solid green; border-radius:2px;">
                                <div class="clearfix"></div>
<br>
                                <label>Name Of Job:</label>
                                <div class="clearfix"></div>
                                <br>
                                <input type="text" class="w3-input M-Green-Inputs-Forms" placeholder="Job name will be shown by database here"
...
<br>
                                    ...
                                    <div class="clearfix"></div>
                                    <br>
                                    <input type="text" placeholder="how much of project will you deliver in the following price and time "
...
<br>
                                ...
                                <div>
                                    <ul class="M-No-Style-List col-md-12">
                                        <li class="M-LiLeft M-Styling-Li">
                                            <p>Price:</p>
                                            <input type="number" placeholder="Select" class="M-Green-Inputs-Forms"><span> PKR</span></li>
        ...
        <textarea class="w3-input" placeholder="Describe yourself and your skills in order to win the job" rows="5"
                  style="border:1px solid green;"></textarea>
                                <div>
                                    ...
                                    <br>
                                    <input style="height:3em;" class="col-sm-12 col-md-12 col-lg-12 M-Green-Inputs-Forms"
                                ...
                                <div style=" margin-top:1em;">
                                    <button type="submit" class="btn btn-block M-UniversalBtn M-button-orange-to-white btn-sm"
                                            style=" width:10em;  margin-top:1em; font-size: small;"><a class="M-Universal-Link">Apply</a></button>
                                    <br>
                                </div>
                            </form>
                        </li>
