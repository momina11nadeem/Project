          ...
          <div>
            <center>
              <table class="table table-bordered" style="margin-top:3em;">
                ...
                <tbody>
                <tr>
                  <td class="text-center">fully functional site in wordpress</td>
                  <td class="text-center"><span ><a  href="application-from-employee.php" class="M-Universal-Link">Maria</a></span>
<br>
                    <span ><a  href="application-from-employee.php" class="M-Universal-Link">Zeeshan</a>
                  </td>

                  <td class="text-center"><a href=" Employee Profile.php" class="M-Universal-Link">Maria</a></td>
                  <td class="text-center"><a href="interview-client-answered.php" class="M-Universal-Link">View filled interview</a></td>
                  <td class="text-center"><a href="project-file-for-client.php" class="M-Universal-Link">View File</a></td>
                    <td class="text-center">
                    <div>
                      <span class="col-sm-12 text-center"><a class="M-Universal-Link">Delete Post</a></span>
                    </div><br>
                    <div>
