...
<section class="w3-container" style="background-color:white; padding-bottom:3em; margin-top:5em;">
 ...
 <h2 class="text-center">Queries of Client</h2>
 <br><br><br>
...
<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
 ...
 4and scrambled it to make a type specimen book.
 It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
<label style="margin-top:1em;">Attatchment</label>
<span>file will be placed here</span>
<button class="btn btn-block M-button-orange-to-white btn-sm" style="margin-top:2em;"><a style="font-family: Arial; font-size: large;" class="M-Universal-Link">Schedule Resubmission</a></button>
</form>
