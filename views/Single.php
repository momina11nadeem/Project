                ...
                <ul style="list-style-type:none !important; text-decoration:none !important; padding-top:1em;">
                    ...
                    <li style="padding-top:0.5em;" class="col-sm-2">
                        <button class="btn-small M-button-Grey-to-white M-UniversalBtn btn-sm"><a
                                    class="M-Universal-Link">SEARCH</a></button>
                    </li>
                    </li>
                    <li class="col-md-12">
                        <div>
                            <form style=" margin-top:1em !important;">
                                ...
                                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3"
                                     style="float: left; margin-left:-1.7em;">
    ...
    <ul class="M-No-Style-List w3-container " style="padding-top:3em;"><!-- main ul  -->
        <li class=" M-LiLeft w3-container" style="border:2px solid green; width: 70%;"><!-- 1st li of main ul  -->
            <div>
                ...
                <div class="row w3-container">
                    ...
                    <div class="pull-right">
                        ...
                        <p class="text-justify">   <?php if ($haveJobDetail['catagory'] == "") {
                                echo "NULL";
                            } else echo $haveJobDetail['catagory']; ?>
                ...
                <div class="row w3-container">
                    <div class="pull-left">
                        <h5><strong>Career Level:</strong></h5>
                        <p class="text-justify">   <?php if ($haveJobDetail['career_level'] == "") {
                                echo "NULL";
                            } else echo $haveJobDetail['career_level']; ?>
                        </p>
                    </div>
                    <div class="pull-right">
                        <h5><strong>Duration:</strong></h5>
                        <p class="text-justify">   <?php if (empty($haveJobDetail['duration'])) {
                                echo "NULL";
                            } else {
                                echo $haveJobDetail['duration'];
                            } ?>
                ...
                <div class="row w3-container">
                    ...
                    <div class="pull-right">
                        ...
                        <p>
                            <span><?php echo $haveJobDetail['price_from']; ?>
                                PKR</span>-<span><?php echo $haveJobDetail['price_to']; ?></span><span> PKR</span>
                        </p>
        ...
        <li class="pull-right" style="width:25%;"><!-- 2nd li of main ul -->
            <div>
                <a class="M-Universal-Link" style="text-decoration:none !important;"
                   href="Apply-Job.php?JobID=<?php echo $haveJobID ?>&JobName=<?php echo $haveJobDetail['title']; ?>">
            ...
            <div style="margin-top:2em;">
                <a class="M-Universal-Link" style="text-decoration:none !important;" href="#">
                    <button class=" btn-block btn-sm M-button-Red" style="height: 3.2em;"><a style="font-size: medium;"
                                                                                             class="M-Universal-Link">Report
                            Job</a></button>
                </a>
            </div>
            <!--  <div style="margin-top:2em;">
